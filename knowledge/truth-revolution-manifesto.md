...
Different groups adopt different narratives—not because they evaluated the same evidence differently, but because they no longer shared a process for evaluating evidence at all.
Some doubled down on institutional authority.
Others rejected it entirely.
Many disengaged.
Truth ceased to be a shared reference point.
